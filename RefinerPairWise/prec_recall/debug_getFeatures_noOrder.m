...
function [features_all]=debug_getFeatures_noOrder(record_lists)
...
% function [features_all,det_scores_all,error_files]=debug_getFeatures_noOrder(record_lists,models,ratio)
% if isstruct(record_lists)
%     features_all=debug_getFeatures_noOrder_single(record_lists);
% else
%     dir_in=record_lists;
...
%             debug_getFeatures_noOrder_single(record_lists);
%         
...
% 
% 
% function [features_all]=debug_getFeatures_noOrder_single(record_lists)
% bin_occupied=record_lists.dpm_thresh_bin;
% idx_occupied=find(bin_occupied(2:end));
% 
% 
