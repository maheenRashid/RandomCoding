...
#OUTPUT_FILER=/lustre/${USER}/patchDetectors/${PROCSTRING}.${HOSTNAME}.$$.output
OUTPUT_FILER=/lustre/maheenr/log_files_warp/${PROCSTRING}.${HOSTNAME}.$$.output

touch OUTPUT_FILER

#1.) Jump into my home directory
cd /home/maheenr/results_temp_09_13/code_RefinerPairWise/code_RefinerPairWise_smooth_pipeline
...
#nice 
matlab -nodesktop -nosplash -r "try,${PROCSTRING};,catch,disp('Error with script ${PROCSTRING}');end;exit(1);" > $OUTPUT_FILER
