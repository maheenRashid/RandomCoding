...
for folder_no=1:numel(folders)
    ...
    parfor i=1:numel(record_box_info_all)
        ...
        record_box_info_all_copy(i)=getTopNFromFileStruct(n,record_box_info_all(i));
        
    end
    matlabpool close;
    record_box_info_all=record_box_info_all_copy;
    save(fullfile(dir_parent,folder,['record_box_info_all_top_' num2str(n) '.mat']),'record_box_info_all');
