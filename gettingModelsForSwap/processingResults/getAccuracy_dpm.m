...
[record_detections(:).dpm_bbox_overlap]=deal(tmp{:});
[record_detections(:).dpm_boxes]=deal(tmp{:});
[record_detections(:).dpm_bin]=deal(tmp{:});
[record_detections(:).dpm_objmap]=deal(tmp{:});
[record_detections(:).dpm_cat_no]=deal(tmp{:});
...
save(fullfile(dir_parent,[folder '_html'],'record_detections_dpm.mat'),'record_detections');
